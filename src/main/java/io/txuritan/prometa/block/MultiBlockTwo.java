...
import io.txuritan.prometa.item.ItemMultiBlockTwo;
...
{
	private final String name = "mb2two";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockTwo()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockTwo.class, name); icons = new IIcon[maxMeta]; }
