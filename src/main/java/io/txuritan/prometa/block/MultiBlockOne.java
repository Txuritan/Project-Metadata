...
import io.txuritan.prometa.item.ItemMultiBlockOne;
...
public class MultiBlockOne extends Block
{
	private final String name = "mb1one";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockOne()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockOne.class, name); icons = new IIcon[maxMeta]; }
