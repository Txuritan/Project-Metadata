...
import io.txuritan.prometa.item.ItemMultiBlockFive;
...
public class MultiBlockFive extends Block
{
	private final String name = "mb5five";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockFive()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockFive.class, name); icons = new IIcon[maxMeta]; }
