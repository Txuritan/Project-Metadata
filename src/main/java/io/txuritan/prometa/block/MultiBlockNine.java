...
import io.txuritan.prometa.item.ItemMultiBlockNine;
...
public class MultiBlockNine extends Block
{
	private final String name = "mb9nine";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockNine()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockNine.class, name); icons = new IIcon[maxMeta]; }
