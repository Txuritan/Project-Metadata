...
import io.txuritan.prometa.item.ItemMultiBlockFour;
...
public class MultiBlockFour extends Block
{
	private final String name = "mb4four";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockFour()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockFour.class, name); icons = new IIcon[maxMeta]; }
