...
import io.txuritan.prometa.item.ItemMultiBlockThree;
...
public class MultiBlockThree extends Block
{
	private final String name = "mb3three";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockThree()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockThree.class, name); icons = new IIcon[maxMeta]; }
