...
import io.txuritan.prometa.item.ItemMultiBlockTen;
...
public class MultiBlockTen extends Block
{
	private final String name = "mb10ten";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockTen()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockTen.class, name); icons = new IIcon[maxMeta]; }
