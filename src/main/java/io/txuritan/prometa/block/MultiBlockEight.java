...
import io.txuritan.prometa.item.ItemMultiBlockEight;
...
public class MultiBlockEight extends Block
{
	private final String name = "mb8eight";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockEight()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockEight.class, name); icons = new IIcon[maxMeta]; }
