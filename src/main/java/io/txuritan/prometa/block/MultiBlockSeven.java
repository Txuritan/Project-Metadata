...
import io.txuritan.prometa.item.ItemMultiBlockSeven;
...
public class MultiBlockSeven extends Block
{
	private final String name = "mb7seven";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockSeven()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockSeven.class, name); icons = new IIcon[maxMeta]; }
