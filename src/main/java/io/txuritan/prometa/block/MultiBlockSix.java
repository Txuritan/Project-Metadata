...
import io.txuritan.prometa.item.ItemMultiBlockSix;
...
public class MultiBlockSix extends Block
{
	private final String name = "mb6six";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockSix()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockSix.class, name); icons = new IIcon[maxMeta]; }
