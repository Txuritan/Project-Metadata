...
import io.txuritan.prometa.item.ItemMultiBlockTwelve;
...
public class MultiBlockTwelve extends Block
{
	private final String name = "mb12twelve";
	private int maxMeta = 16;
	
	private IIcon[] icons;
	
	public MultiBlockTwelve()
	{ super(Material.rock); setBlockName(Info.MODID); setCreativeTab(CreativeTab.tabProMetaBlock); GameRegistry.registerBlock(this, ItemMultiBlockTwelve.class, name); icons = new IIcon[maxMeta]; }
